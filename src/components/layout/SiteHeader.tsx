...
export const GITHUB_URL = 'https://github.com/Vincent-Huang-2000/dataforge';
...
export function SiteHeader() {
  ...
  return (
    <header className="border-hairline bg-surface flex h-11 shrink-0 items-center justify-between border-b px-4">
      <Link to="/" className="flex items-center gap-2" aria-label="DataForge Studio home">
        <BrandMark className="size-5" />
        <span className="text-ink text-sm font-semibold tracking-tight">DataForge Studio</span>
      ...
      <nav aria-label="Primary" className="flex items-center gap-0.5">
        ...
        <div className="bg-hairline mx-1.5 h-4 w-px" aria-hidden="true" />
        ...
        <Tip label="View source on GitHub">
          <a
            ...
            className="text-ink-dim hover:bg-surface-3 hover:text-ink flex size-8 items-center justify-center rounded-(--radius-control) transition-colors duration-100"
          >

...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  def({
    ...
    nativeCtx: 262144,
    templateFamily: 'chatml',
    reasoningMode: 'separate-checkpoints',
    toolCallStyle: 'hermes',
    license: 'Apache-2.0',
    recommendedSeqLen: 4096,
    sizeClass: 'small',
    released: '2025-07',
    notes:
      'Non-thinking checkpoint; the 2507 refresh replaced hybrid mode with separate Instruct/Thinking models.',
  }),
  def({
  ...
  def({
    ...
    released: '2025-04',
    notes:
      'Marketing context is 10M tokens; practical SFT sequence length is far lower — use recommendedSeqLen. Llama 5 has NOT been released as of 2026-06 (claims to the contrary are SEO spam).',
  }),
  def({
    id: 'llama-4-maverick',
  ...
  def({
    id: 'deepseek-v3-0324',
    hfId: 'deepseek-ai/DeepSeek-V3-0324',
  ...
  def({
    ...
    totalParams: '3B',
    nativeCtx: 131072,
    templateFamily: 'mistral-tekken',
    reasoningMode: 'none',
    toolCallStyle: 'mistral',
    multimodal: ['image'],
    license: 'Apache-2.0',
    recommendedSeqLen: 4096,
    sizeClass: 'small',
  ...
  def({
    id: 'ministral-3-8b',
    hfId: 'mistralai/Ministral-3-8B-Instruct-2512',
    name: 'Ministral 3 8B',
    vendor: 'Mistral AI',
    family: 'Ministral',
    totalParams: '8B',
  ...
  def({
    ...
    hfId: 'mistralai/Magistral-Small-2509',
  ...
  def({
    ...
    hfId: 'microsoft/Phi-4-reasoning-vision-15B',
  ...
  def({
    id: 'kimi-k2-thinking',
    hfId: 'moonshotai/Kimi-K2-Thinking',
  ...
  def({
    ...
    reasoningMode: 'always-on',
    thinkDelimiters: 'harmony-channel',
    toolCallStyle: 'harmony-ts',
    license: 'Apache-2.0',
    recommendedSeqLen: 8192,
    sizeClass: 'medium',
    released: '2025-08',
  ...
  def({
    ...
    hfId: 'ibm-granite/granite-4.0-h-tiny',
  ...
  def({
    ...
    hfId: 'ibm-granite/granite-4.0-h-small',
  ...
  def({
    id: 'granite-4.1-3b',
    hfId: 'ibm-granite/granite-4.1-3b',
    name: 'Granite 4.1 3B',
    vendor: 'IBM',
    family: 'Granite 4',
    totalParams: '3B',
  ...
  def({
    id: 'olmo-2-7b',
    hfId: 'allenai/OLMo-2-1124-7B-Instruct',
  ...
  def({
    id: 'olmo-2-32b',
    hfId: 'allenai/OLMo-2-0325-32B-Instruct',
  ...
  def({
    ...
    hfId: 'allenai/Olmo-3-7B-Instruct',
  ...
  def({
    ...
    hfId: 'allenai/Olmo-3.1-32B-Instruct',
  ...
  def({
    ...
    hfId: 'allenai/Olmo-3.1-32B-Think',

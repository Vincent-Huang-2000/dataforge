...
**Live app (upstream demo):** https://natekali.github.io/dataforge/
...
```bash
git clone https://github.com/Vincent-Huang-2000/dataforge.git
cd dataforge
pnpm install
pnpm dev
```
...
This project is a fork of [natekali/dataforge](https://github.com/natekali/dataforge). All credit for the original work goes to [@natekali](https://github.com/natekali) and the upstream contributors.

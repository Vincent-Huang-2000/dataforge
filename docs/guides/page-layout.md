...
**一句话**：应用分为**站点页**（项目主页、设置）和**项目工作台**；进入项目后，固定的**左侧导航轨**与**顶部工具栏**包围一个随路由变化的**内容页**。
...
| 导航轨 | `NavRail` | 工作台左侧固定 64px 图标导航；切换 Data、Import、Generate、Quality、Analytics、Export，也可回主页或进入设置。 |
